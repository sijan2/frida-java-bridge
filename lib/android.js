...
export function getArtClassSpec (vm) {
  ...
  vm.perform(env => {
    ...
    try {
      ...
      // Note: On Android 16+ (API 36+), the copied_methods_offset_ field was removed
      // from mirror::Class. When not found, we leave offsetCopiedMethods as 0 and
      // class-model.js will use the array length from read_art_array() instead.
